...
public class ViewStudentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R1.layout.viewstudent);

        spinnerbranch=(Spinner)findViewById(R1.id.spinnerbranchView);
        spinneryear=(Spinner)findViewById(R1.id.spinneryearView);
        ...
        submit=(Button)findViewById(R1.id.submitButton);
