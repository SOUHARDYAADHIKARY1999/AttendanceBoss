...
public class AddAttendanceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final ArrayList<String> studentList = new ArrayList<String>();
        ...
        listAdapter = new ArrayAdapter<String>(this, R1.layout.add_student_attendance, R1.id.labelA, studentList);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                dialog.setContentView(R1.layout.test_layout);
                // set title and cancelable
                RadioGroup radioGroup;
                RadioButton present;
                RadioButton absent;
                radioGroup = (RadioGroup) dialog.findViewById(R1.id.radioGroup);
                present=(RadioButton)dialog.findViewById(R1.id.PresentradioButton);
                absent=(RadioButton)dialog.findViewById(R1.id.AbsentradioButton);
                radioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {

                    @Override
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        if(checkedId == R1.id.PresentradioButton) {

                            status = "P";
                        } else if(checkedId == R1.id.AbsentradioButton) {
                ...
                attendanceSubmit = (Button)dialog.findViewById(R1.id.attendanceSubmitButton);
