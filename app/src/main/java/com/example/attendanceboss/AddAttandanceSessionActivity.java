...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R1.layout.add_attandance);

        //Assume subject will be SE
        //subjectFinal = subjectSEString;

        spinnerbranch=(Spinner)findViewById(R1.id.spinner1);
        spinneryear=(Spinner)findViewById(R1.id.spinneryear);
        spinnerSubject=(Spinner)findViewById(R1.id.spinnerSE);
        ...
        date = (ImageButton) findViewById(R1.id.DateImageButton);
        /** cal = Calendar.getInstance();
        day = cal.get(Calendar.DAY_OF_MONTH);
        month = cal.get(Calendar.MONTH);
        dyear = cal.get(Calendar.YEAR);
        dateEditText = (EditText) findViewById(R1.id.DateEditText);*/
        ...
        submit=(Button)findViewById(R1.id.buttonsubmit);
        ...
        viewAttendance=(Button)findViewById(R1.id.viewAttendancebutton);
        ...
        viewTotalAttendance=(Button)findViewById(R1.id.viewTotalAttendanceButton);
