...
public class AddFacultyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R1.layout.addfaculty);


        textFirstName=(EditText)findViewById(R1.id.editTextFirstName);
        textLastName=(EditText)findViewById(R1.id.editTextLastName);
        textcontact=(EditText)findViewById(R1.id.editTextPhone);
        textaddress=(EditText)findViewById(R1.id.editTextaddr);
        textusername=(EditText)findViewById(R1.id.editTextUserName);
        textpassword=(EditText)findViewById(R1.id.editTextPassword);
        registerButton=(Button)findViewById(R1.id.RegisterButton);
